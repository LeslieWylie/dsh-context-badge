window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function recordFor(store, context, scope) {
      ...
      return (store.records && store.records[key]) || { note: "", todos: [], updatedAt: 0 };
    }
    ...
    function ContextBadge(props) {
      ...
      return React.createElement(React.Fragment, null,
        ...
        open ? React.createElement(BadgePanel, { context: ctx, scope: scope, record: record, recent: store.recent || [], onChange: update, onScopeChange: setScope, onClose: function () { setOpen(false); } }) : null);
    }
    ...
    module.exports = {
      ...
      __testables: { sessionContext: sessionContext, fmt: fmt, newTodo: newTodo, normalizeStore: normalizeStore, recordFor: recordFor },
    };
